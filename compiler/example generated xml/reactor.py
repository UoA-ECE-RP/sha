...
extEves = ExternalEvents({ Event("clock") : [Symbol("x"), Symbol("timer1"), Symbol("timer2")] }, { Event("add1") : [], Event("add2") : [], Event("remove1") : [], Event("ewmove2") : [], Event("refresh1") : [], Event("refresh2") : []})

extVars =  ExternalVars([Symbol("x"), Symbol("timer1"), Symbol("timer2")],[])
